; ModuleID = '/Users/gab/repo/llvm_new/llvm-project/libcxx/src/mutex_destructor.cpp'
source_filename = "/Users/gab/repo/llvm_new/llvm-project/libcxx/src/mutex_destructor.cpp"
...
define noundef %"class.std::__1::mutex"* @_ZNSt3__15mutexD2Ev(%"class.std::__1::mutex"* noundef nonnull returned align 8 dereferenceable(64) %this) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  %call = invoke noundef i32 @_ZNSt3__122__libcpp_mutex_destroyEP23_opaque_pthread_mutex_t(%struct._opaque_pthread_mutex_t* noundef %__m_)
...
define linkonce_odr hidden noundef i32 @_ZNSt3__122__libcpp_mutex_destroyEP23_opaque_pthread_mutex_t(%struct._opaque_pthread_mutex_t* noundef %__m) #1 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define noundef %"class.std::__1::mutex"* @_ZNSt3__15mutexD1Ev(%"class.std::__1::mutex"* noundef nonnull returned align 8 dereferenceable(64) %this) unnamed_addr #0 align 2 {
entry:
  %this.addr = alloca %"class.std::__1::mutex"*, align 8
  store %"class.std::__1::mutex"* %this, %"class.std::__1::mutex"** %this.addr, align 8
  %this1 = load %"class.std::__1::mutex"*, %"class.std::__1::mutex"** %this.addr, align 8
  %call = call noundef %"class.std::__1::mutex"* @_ZNSt3__15mutexD2Ev(%"class.std::__1::mutex"* noundef nonnull align 8 dereferenceable(64) %this1) #5
  ret %"class.std::__1::mutex"* %this1
}

declare i32 @pthread_mutex_destroy(%struct._opaque_pthread_mutex_t* noundef) #3
